...
import com.mehmaa.blog.repository.AccountRepository;
...
public class AuthentificationService implements UserDetailsService {
	...
	@Autowired
	public AuthentificationService(AccountRepository userRepository,
			AccountHelper accountHelper, InitDataService initDataService) {
	...
	public UserDetails loadUserByUsername(String email)
		...
		Collection<GrantedAuthority> grantedAuthorities = toGrantedAuthorities(accountHelper
				.getRoleNames(user));
